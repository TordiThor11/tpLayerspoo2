...
public class VentanaInscripcion {
    ...
    public VentanaInscripcion(IApi api) {
        this.api = api;
    ...
    private void formElements() {
        ...
        try {
            cargarConcursosAbiertosEnComboBox();
        } catch (Exception e) {
    ...
    private void cargarConcursosAbiertosEnComboBox() throws Exception {
        var concursos = api.obtenerConcursosAbiertos();
        for (Concurso concurso : concursos) {
            this.comboBox.addItem(concurso.getNombre());
        }
    }

    private void saveInscription() throws Exception {
        var concurso = api.buscarConcurso((String) comboBox.getSelectedItem());
        if (validations()) {
            api.cargarParticipante(new Participante(txtLastName.getText(), txtName.getText(), txtPhone.getText(), txtEmail.getText()), concurso);
        }
    }
